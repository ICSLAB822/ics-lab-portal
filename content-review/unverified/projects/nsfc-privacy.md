...
review_status: unverified_demo_content
...
This project addresses the critical conflict between data utility and privacy preservation in Mobile Crowdsensing (MCS). As MCS applications proliferate in smart city scenarios, participants are reluctant to share sensory data due to privacy concerns.
